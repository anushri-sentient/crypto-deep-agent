...
def search_rss_articles(logger, query, max_results=10):
    """
    Search RSS feeds and filter articles by the query string in the title or description.
    Args:
        logger: Logger for debug/info output.
        query (str): The search query.
        max_results (int): Number of results to return.
    Returns:
        list: List of article dicts with id, title, description, published_at, url, source_name, and source.
    """
    rss_feeds = [
        'https://feeds.bloomberg.com/markets/news.rss',
        'https://moxie.foxbusiness.com/google-publisher/markets.xml',
